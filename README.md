...
- `newLaunchParticipationId` - (applies to `updateParticipation` requests) This is provided to the user and would not come from user input. This will be generated by the backend once validations are done.
